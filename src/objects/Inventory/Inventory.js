...
events.on("HERO_PICKS_UP_ITEM2", this, data => {
      this.nextId += 1;
      this.items.push({
        id: this.nextId,
...
events.on("HERO_PICKS_UP_ITEM3", this, data => {
      this.nextId += 1;
      this.items.push({
        id: this.nextId,
    ...
    events.on("HERO_PICKS_UP_ITEM4", this, data => {
      this.nextId += 1;
      this.items.push({
        id: this.nextId,
    ...
    events.on("HERO_PICKS_UP_ITEM5", this, data => {
      this.nextId += 1;
      this.items.push({
        id: this.nextId,
